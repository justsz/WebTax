                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="id" title="${message(code: 'dataset.id.label', default: 'Id')}" />
                    ...
                    <g:each in="${datasetInstanceList}" status="i" var="datasetInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:link action="show" id="${datasetInstance.id}">${fieldValue(bean: datasetInstance, field: "id")}</g:link></td>
                        
                            <td>${fieldValue(bean: datasetInstance, field: "name")}</td>
